...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7847935184:AAFDvBAsmfo_V6OwO5aLYobggqZwTzvfsgc") 
    ...
    FORCE_SUB_CHANNELS = os.environ.get('FORCE_SUB_CHANNELS', '-1002034112983').split(',')
